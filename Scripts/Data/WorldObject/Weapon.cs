...
public class Weapon : MonoBehaviour
{
    ...
    void CreateShotSFX()
    {
        ...
        shotSFX     = GlobalScene.Instance.InstantiateResource(path, transform).GetOrAddComponent<ParticleSystem>();
    ...
    void DestroyShotSFX()
    {
        ...
        {
            GlobalScene.Instance.DestroyGameObject(shotSFX.gameObject);
        }
        shotSFX = null;
    }
